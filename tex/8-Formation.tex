...
Formation is a key problem in robotic swarms, due to its high usage in other problems and composite problems.\todo{Find references.}
...
We will discuss each of these algorithms separately and comparing them at the end of the chapter.
