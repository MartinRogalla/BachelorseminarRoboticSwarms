...
We handle these two different problems separately because they are two entirely different problems that together compose the whole collective transport problem. 
...
\subsection{User-controlled swarm transportation algorithms}
...
It considers a multi-robot formation control framework called cluster space control.
...
\subsection{Autonomous swarm transportation algorithms}
The second subporoblem that has to be solved is finding the payload and transporting it to its destination.
