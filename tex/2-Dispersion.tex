...
We consider dispersion as one of the sub-problems needed to be solved in Robotic Swarms.\cite{ugur2007dispersion,mclurkin2007distributed,ludwig2006robotic} Dispersion can be compared to the blanket coverage problem.\cite{gage1992command} The objective of blanket coverage is defined as ``achieve a static arrangement of elements that maximizes the detection rate of targets appearing within the coverage area.''\cite{gage1992command}

\subsection{Applications}
Exploration, surveillance, military, disaster response, planetary exploration and many other applications require dispersion.\cite{ludwig2006robotic,Penders2011,mclurkin2007distributed} Therefore all of these applications can be seen as super-problems of dispersion.
