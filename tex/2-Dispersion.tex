...
When discussing the \emph{scalability}, we mean [explanation]. When discussing the \emph{performance} we mean [explanation]. \todo{fill in what scalability and performance are}

\subsubsection{Randomness Approach}\todo{Probabilistic approach? Randomly based approach? Something like that.}
