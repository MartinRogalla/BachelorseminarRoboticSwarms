...
In Section \ref{sec:CollectiveTransport} until Section \ref{sec:Formation} we will define the problems in robotic swarms, where we mention the applications and their underlying solutions.
