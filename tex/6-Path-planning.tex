...
The second algorithm we will discuss is the Artificial Bee Colony algorithm. \cite{Bhattacharjee}
...
A third algorithm we will research is the Multihop Communication algorithm. \cite{Jung}
...
The last algorithm we will discuss here is Genetic Programming. \cite{Kala}
